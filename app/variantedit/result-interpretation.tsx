...
type Variant = {
  ...
  type ResultInterpretationProps = {
    ...
    setVariantExplanations: React.Dispatch<React.SetStateAction<{ [key: string]: string }>>;
...
function ResultInterpretation({selectedVariants, 
    setSelectedVariants, 
...
editText,
setEditText,
setEditingVariant}: ResultInterpretationProps){
